...
(function () {
  ...
  <div class="flex items-center gap-4 flex-shrink-0">
    ...
    /* aTrust 侧边栏 Sider（访问体验监测菜单，菜单项跳转） */
    /* activePage 用于高亮当前页，由外部 x-data 提供 */
  ...
  <div class="overflow-y-auto custom-scrollbar flex-1 py-2 space-y-1">
    ...
    <div>
      <div class="sase-menu-l1 parent-active" @click="toggleSaseL1('dem-monitoring')">
        ...
        <span class="font-semibold text-white">访问体验监测</span>
        <svg class="ml-auto w-3.5 h-3.5 opacity-60 transition-transform duration-200 rotate-90" fill="none" stroke="currentColor" viewBox="0 0 24 24">
  ...
  <div class="sase-footer">
    ...
    /**
     * 将双底座框架注入到 #shell-atrust 和 #shell-sase 容器中
     * 各子页面的 body 内只需要以下结构（由页面模板提供）：
     *   <div x-data="dualShellAppStore('体验预警')">
     *     <div id="shell-switcher"></div>
     *     <div id="shell-atrust" ...>
     *       <!-- aTrust框架将被注入到此处 -->
     *       <div id="atrust-workspace"> ... 页面专属内容 ... </div>
     *     </div>
     *     <div id="shell-sase" ...>
     *       <!-- SASE框架将被注入到此处 -->
     *       <div id="sase-workspace"> ... 页面专属内容 ... </div>
     *     </div>
     *   </div>
     */
    inject() {
      const doInject = () => {
        ...
        // 覆层盖住页面初始渲染的白屏 flash，Alpine 注入完毕后再淡出，实现丝滑入场。
